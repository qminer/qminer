...
function testMerger() {
    ...
    var stores = [qm.store('sig1'), qm.store('sig2'), qm.store('sig3'), qm.store('sig4')];
    ...
    while (true) {
        ...
        console.say('inserting: ' + JSON.stringify(insertObj));
        store.add(insertObj);
    }

    var store = qm.store('joined');
    ...
    var stores = [qm.store('sig11'), qm.store('sig12')];
    ...
    var stores = [qm.store('sig111'), qm.store('sig112')];
...
function testResampler() {
    ...
    var rawStore = qm.store('resampled_in');
    var resampledStore = qm.store('resampled_out');
