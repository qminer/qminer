...
assert.equals(People.forwardIter.next(), false, "People.forwardIter.next()");
...
assert.equals(Movies.forwardIter.next(), false, "Movies.forwardIter.next()");
...
assert.equals(PeopleIter.next(), true, "People.forwardIter.next()");
assert.equals(PeopleIter.rec.$id, 0, "People.forwardIter.rec.$id");
assert.equals(PeopleIter.next(), true, "People.forwardIter.next()");
assert.equals(PeopleIter.rec.$id, 1, "People.forwardIter.rec.$id");
assert.equals(PeopleIter.next(), false, "People.forwardIter.next()");
...
assert.equals(MoviesIter.next(), true, "Movies.forwardIter.next()");
assert.equals(MoviesIter.rec.$id, 0, "Movies.forwardIter.rec.$id");
assert.equals(MoviesIter.next(), false, "Movies.forwardIter.next()");
...
assert.equals(moviesCount, 0, "moviesCount = 0");
// test first record
assert.equals(Movies.first.$id, 0, "Movies.first.$id");
// test last record
assert.equals(Movies.last.$id, Movies.length - 1, "Movies.last.$id");
