...
namespace TQuant {
    ...
    namespace TUtils {
        ...
        public:
            TBasicGkTuple(): MxVal() {}
            TBasicGkTuple(const double&);
            TBasicGkTuple(const double& Val, const TBasicGkTuple& RightTuple);

            void Swallow(const TBasicGkTuple&);
            ...
            friend std::ostream& operator <<(std::ostream& os, const TBasicGkTuple& Tuple) {
                return os << "<"
                          << Tuple.GetMxVal() << ", "
                          << Tuple.GetTupleSize() << ","
