...
private:
    // type aliases
    using TScaleStateHistVPrV = TVec<TPair<TFlt, TVec<TTriple<TUInt64,TUInt64,TIntFltH>>>>;
...
private:
    ...
    static void DumpScaleStateHistVV(const TScaleStateHistVPrV& ScaleStateHistVV);
};
