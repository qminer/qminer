...
* @param {(Object | module:fs.FIn)} [params] - The parameters for the construction.
* @param {number} [params.maxSecs=500] - The maximum time period to compute MDS of a matrix.
* @param {number} [params.maxStep=5000] - The maximum number of iterations.
* @param {number} [params.minDiff=1e-4] - The minimum difference criteria in MDS.
* @param {string} [params.distType="Euclid"] - The type of distance used. Available types: "Euclid", "Cos", "SqrtCos".
* @example
* // import analytics module
* var analytics = require('qminer').analytics;
...
/**
	* Get the parameters.
	* @returns {object} The json object containing the parameters of the instance.
	* @example
	* // import analytics module
	* var analytics = require('qminer').analytics;
