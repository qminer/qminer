...
module.exports = exports = function (pathQmBinary) {
	...
	*/
    exports.SVC.prototype.getModel = function() { return { weights: this.weights, bias: this.bias, supportVectors: this.supportVectors, coefficients: this.coefficients }; }
    /**
	* Get the model.
	* @returns {Object} The `svmModel` object containing the property:
    * <br> 1. `svmModel.weights` - The weights of the model. Type {@link module:la.Vector}.
	...
	*/
    exports.SVR.prototype.getModel = function() { return { weights: this.weights, bias: this.bias, supportVectors: this.supportVectors, coefficients: this.coefficients }; }
