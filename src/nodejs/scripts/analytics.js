...
module.exports = exports = function (pathQmBinary) {
    ...
    */
     ...
     * @param {(module:la.Matrix | module:la.SparseMatrix)} C - Matrix containing the centroids.
     * @param {module:la.IntVector} idxv - The integer vector containing the cluster ids of the training data.
     */
    ...
    * var model = KMeans.getModel();
    */
    exports.KMeans.prototype.getModel = function () { return { C: this.centroids, idxv: this.idxv }; }
