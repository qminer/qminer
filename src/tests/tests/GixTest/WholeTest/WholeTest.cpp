...
public:
	...
	static void TPgBlob_AddBf1() {
		...
		auto pb = TPgBlob("data/pb", TFAccess::faCreate, 4194304);
...
//	}
//	{
//		TPt<TQm::TBase> Base = TQm::TStorage::LoadBase(dir, TFAccess::faRdOnly, 2 * 1024 * 1024, 2 * 1024 * 1024, TStrUInt64H(), true, 4 * TInt::Kilo);
//
...
//	printf("++++ loop: %d\n\n", sw.GetMSecInt());
//	
//	Sleep(1000); // so that files are properly closed
//
//	{
//		printf("Starting - new implementation - insert and delete\n");
//		TPt<TQm::TBase> Base = TQm::TStorage::NewBase(dir, SchemaVal, 2 * 1024 * 1024, 2 * 1024 * 1024, TStrUInt64H(), true, 4 * TInt::Kilo);
...
//
//TEST(testTStorePbBlob, ToastTest1) {
//	TStr def_file = ".\\pgblob_test_str2.def";
//	TQm::TEnv::Init();
//	TStr unicode_file = "..\\..\\..\\..\\..\\src\\glib\\bin\\UnicodeDef.Bin";
//	TStr dir = "data\\";
...
//	TStr def_file = ".\\pgblob_test_str3.def";
//	TQm::TEnv::Init();
//	TStr unicode_file = "..\\..\\..\\..\\..\\src\\glib\\bin\\UnicodeDef.Bin";
//	TStr dir = "data\\";
//
...
//		sw.Reset(true);
//
//		auto field_id_str4 = store->GetFieldId("FieldString4");
//		auto rs = store->GetAllRecs();
//		for (int i = 0; i < rs->GetRecs(); i++) {
//			if (i % 10000 == 0) printf("    %d\r", i);
//			rs->GetRec(i).SetFieldStr(field_id_str4, "--");
//		}
//		sw.Stop();
//		printf("++++ update short: %d\n\n", sw.GetMSecInt());
//		TQm::TStorage::SaveBase(Base);
//	}
//	try {
//		{
